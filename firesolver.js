...
(function() {
  'use strict';
  angular.module('holmesal.firesolver', ['firebase']).service('Firesolver', function($rootScope, $firebase, $firebaseSimpleLogin, $q) {
    var Firesolver;
    Firesolver = (function() {
      function Firesolver() {
        var auth;
      ...
      Firesolver.prototype.deferUser = function() {
        return this.deferredAuthUser.promise.then((function(_this) {
          return function(authUser) {
            ...
            userRef = _this.rootRef.child('users').child(authUser.uid);
