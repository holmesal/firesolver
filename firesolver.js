...
(function() {
  'use strict';
  angular.module('holmesal.firesolver', ['firebase']).service('Firesolver', [
    '$rootScope', '$firebase', '$firebaseSimpleLogin', '$q', '$timeout', function($rootScope, $firebase, $firebaseSimpleLogin, $q, $timeout) {
      var Firesolver;
      Firesolver = (function() {
        function Firesolver() {
          var auth;
